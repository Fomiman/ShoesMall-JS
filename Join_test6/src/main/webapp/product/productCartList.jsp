...
<script>
	...
	function checkQtyUp(product_name){ 
			location.href="productCartQtyUp.shoes?product_name="+ encodeURIComponent(product_name);
	}
	function checkQtyDown(product_name,product_amount){
		if(product_amount != 1){//현재 수량이 1이 아니면 (즉 2이상이면)
			location.href="productCartQtyDown.shoes?product_name="+ encodeURIComponent(product_name);
		}
	}
</script>
</head>
    		...
    		<select id = "startMoney" name="startMoney">
    			...
    			<c:choose>
    				...
    				<c:when test="${startMoney==60000 }">
    					<option>50000</option>
    					<option selected="selected">60000</option>
    					<option>70000</option>
	    				<option>80000</option>
    				</c:when>
    				<c:when test="${startMoney==70000 }">
    					<option>50000</option>
    					<option>60000</option>
    					<option selected="selected">70000</option>
	    				<option>80000</option>
    				</c:when>
    				<c:when test="${startMoney==80000 }">
    					...
    					<option>60000</option>
    					<option>70000</option>
	    				<option selected="selected">80000</option>
    				</c:when>
    				<c:otherwise>
    					<option>50000</option>
    					<option>60000</option>
        ...
        <tr>
        	<td>
             ...
             <td>
            	 ...
            	 <a href="javascript:checkQtyUp('${cartTBL.product_name}')"> <!-- 문자는 '' 항상 신경 -->
            	 ...
            	 <a href="javascript:checkQtyDown('${cartTBL.product_name}',${cartTBL.product_amount})"> <!-- 숫자는 ''안써도됨 -->
