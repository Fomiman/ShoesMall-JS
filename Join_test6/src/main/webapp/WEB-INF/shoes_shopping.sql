...
SELECT member_id,member_name,member_phone,member_email,address1,address2,address3 from deliver_address natural join memberTBL;
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `ipc22bjsk`.`memberTBL`(등급추가)
-- -----------------------------------------------------
--CREATE TABLE IF NOT EXISTS `ipc22bjsk`.`memberTBL` (
 -- `member_code` INT NOT NULL,
 -- `member_id` NVARCHAR(12) NOT NULL,
