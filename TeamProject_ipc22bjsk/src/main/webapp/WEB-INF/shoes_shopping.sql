...
CREATE TABLE IF NOT EXISTS `ipc22bjsk`.`deliver_address` (
  ...
  INDEX `fk_deliver_address_memberTBL1_idx` (`member_code` ASC) VISIBLE,
  CONSTRAINT `fk_deliver_address_memberTBL1`
