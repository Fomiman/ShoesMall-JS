...
public class ProductlowPriceAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		ProductTBL lowPrice = ProductListService.lowPrice(product_price);
		...
		request.setAttribute("productTBL",lowPrice);
